...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.instructions.update', $instruction) }}">
        @method('PUT')
        @csrf
        <div class="card_show">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                            value="{{ old('title', $instruction->title) }}" placeholder="Inserisci il titolo..."
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" id="course_study" name="course_study"
                            value="{{ old('course_study', $instruction->course_study) }}"
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" id="valuation" name="valuation"
                            value="{{ old('location', $instruction->valuation) }}" placeholder="Inserisci il voto..."
                            max-lenght="50" required>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="date" class="form-control" id="start_date" name="start_date"
                            value="{{ old('start_date', $instruction->start_date) }}" max-lenght="50" required>
                    </div>

                    <div class="col-12 col-md-6">
                        <label for="end_date" class="mt-3 form-label">Fine</label>
                        <input type="date" class="form-control" id="end_date" name="end_date"
                            value="{{ old('end_date', $instruction->end_date) }}" max-lenght="50" required>
                    </div>

                    <div class="col-12 col-md-10">
                        <label for="image" class="mt-3 form-label">Immagine</label>
                        <input type="url" class="form-control" id="image" name="image"
                            value="{{ old('image', $instruction->image) }}" placeholder="Inserisci un url..."
                            max-lenght="50">
                    </div>
