        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                ...
                <input type="text" class="form-control" id="title" name="title"
                    value="{{ old('title', $instruction->title) }}" placeholder="Inserisci il titolo..." max-lenght="50"
                    required>
            </div>
            ...
            <div class="col-12 col-md-10">
                ...
                <input type="url" class="form-control" id="image" name="image"
                    value="{{ old('image', $instruction->image) }}" placeholder="Inserisci un url..." max-lenght="50">
            </div>
